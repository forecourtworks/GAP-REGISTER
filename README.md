...
Open index.html in Chrome / Safari / Edge (tablet recommended for field sign-off).

For camera/share on a phone, host the folder on HTTPS (any static host).

Fill document meta → + Asset → complete identity → + NC as needed.

Save Draft anytime.

Finish & Share as PDF → complete names/dates → draw or attach signatures → Generate & Share A1 PDF.
